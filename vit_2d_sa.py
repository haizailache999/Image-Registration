...
class VisionTransformer(nn.Module):
    def __init__(self, img_size=4, patch_size=2, in_c=1, num_classes=1,
                 embed_dim=4, depth=12, num_heads=4, mlp_ratio=4.0, qkv_bias=True,
...
def own_model():
    model = VisionTransformer(img_size=4, patch_size=2, in_c=1,embed_dim=4, depth=12, num_heads=4)
    return model